...
const AppActionsPanel: FC = () => {
   ...
   */
  const errors = useSelector((state: RootStateOrAny) => state.actions.errors);
  ...
  const successes = useSelector(
    (state: RootStateOrAny) => state.actions.successes
  );
  ...
  const warnings = useSelector(
    (state: RootStateOrAny) => state.actions.warnings
  );
